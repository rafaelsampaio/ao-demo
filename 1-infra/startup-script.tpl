...
#curl -o /tmp/f5-bigip-runtime-init-1.3.2-1.gz.run https://cdn.f5.com/product/cloudsolutions/f5-bigip-runtime-init/v1.3.2/dist/f5-bigip-runtime-init-1.3.2-1.gz.run && bash /tmp/f5-bigip-runtime-init-1.3.2-1.gz.run -- '--cloud gcp'
